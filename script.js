...
// MAIN FIX: Apply parallax effect only to logos that are NOT in sidebar
contentArea.addEventListener('scroll', () => {
    // Only select company logos that are NOT inside the sidebar
    const allLogos = document.querySelectorAll('.company-logo');
    const sidebar = document.querySelector('.sidebar');
    
    allLogos.forEach(logo => {
        // Check if this logo is inside sidebar
